...
class StaffAppointmentView extends GetView<StaffAppointmentController> {
  const StaffAppointmentView({Key? key}) : super(key: key);
        ...
        children: [
          ...
          DataTitleWidget(
            ...
            titles: [
              ...
              DataTitleModel(name: 'Pet Information', flex: 3),
              DataTitleModel(name: 'Customer Information', flex: 4),
              DataTitleModel(name: 'Doctor Name', flex: 4),
                        ...
                        child: DataTitleWidget(
                          ...
                          titles: [
                            DataTitleModel(
                                ...
                                flex: 2),
                            DataTitleModel(
                                name: data[index].pet?.petName ?? '', flex: 3),
                            DataTitleModel(
                            ...
                            DataTitleModel(
                              ...
                              flex: 4,
                              action: () => controller.showDoctorSelection(
                                data[index],
                              ),
                              actionName: 'Doctor',
                            ),
