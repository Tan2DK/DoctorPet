...
import '../../core/data/request/register_request.dart';
  ...
  Future<void> onTapSubmit() async {
    final response = await authRepo.register(
      registerRequest: RegisterRequest(
        ...
        birthday: birthday.value.formatDateTime('dd-MM-yyyy'),
        email: email.value,
        phone: phone.value,
      ),
    );
    response.fold(
      (l) => Get.snackbar('Register', l, snackPosition: SnackPosition.BOTTOM),
      (r) => Get.back(),
    );
  }
